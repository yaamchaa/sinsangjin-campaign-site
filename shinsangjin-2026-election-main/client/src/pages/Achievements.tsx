...
const ACHIEVEMENTS = [
  {
    category: "재정·행정",
    items: [
      { metric: "전국 1위", label: "재정자립도", body: "경기도 31개 시·군 중 재정자립도 최상위권 유지. 건전한 재정 기반 위에서 과감한 투자 집행." },
      { metric: "96.1%", label: "공약 이행률", body: "민선 8기 총 148개 공약 중 127개 완료 또는 정상 추진. 전국 광역·기초단체 중 최고 수준." },
      { metric: "Zero", label: "중대 행정 사고", body: "대장동 이후 흔들린 행정 신뢰 회복. 투명하고 원칙 있는 행정 프로세스 재정립." },
    ],
  },
  {
    category: "도시 정비",
  ...
  },
  {
    category: "교통·인프라",
    items: [
      { metric: "추진 중", label: "야탑도촌역 신설", body: "국토부 장관 방문 통해 교통망 확충 강력 요청. 분당·수정 연결 신규 역사 추진으로 교통 사각지대 해소." },
      { metric: "연계 착수", label: "위례-삼동선 교통망", body: "위례신도시 유입 인구의 교통 편의 확대. 수정구 신도시권 접근성 대폭 개선." },
      { metric: "고도화", label: "성남하이테크밸리", body: "중원구 핵심 산업 거점의 고도화 추진. 일자리-주거-산업 연계 성남형 도시 모델 구축." },
    ],
  },
  {
    category: "민생·복지",
    items: [
      { metric: "확대 운영", label: "성남형 복지 체계", body: "고령 인구 비율이 높은 중원구·수정구 중심으로 공공의료·돌봄 서비스 체감도 강화." },
      { metric: "지속 지원", label: "소상공인 회복 프로그램", body: "원도심 상권 활성화와 지역화폐 기반 소비 진작으로 민생 경제 안정화." },
