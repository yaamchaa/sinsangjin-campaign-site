...
const ACHIEVEMENTS = [
  ...
  },
  {
    category: "도시 정비",
    items: [
      { metric: "4개 단지", label: "분당 재건축 선도지구 지정", body: "시범단지 23·S6, 샛별마을 31·S4, 목련마을 6·S3, 양지마을 32구역의 특별정비구역 지정 확정. 2만여 세대 재건축의 돌파구." },
  ...
  },
  {
    ...
    items: [
      ...
      { metric: "글로벌센터", label: "위례 포스코 글로벌센터 유치", body: "향후 10년 간 약 16조원 경제적 파급효과. 부지 4만9308㎡(축구장 7개 규모) 지하 5층·지상 12층 규모. 2026년 4월 착공, 2030년 준공 예정, 상주인력 3,300여 명 예상" },
