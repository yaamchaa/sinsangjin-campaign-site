...
const TIMELINE = [
  { year: "2022–", title: "민선 8기 성남시장", body: "공약 이행률 97.4% 달성, 재정자립도 전국 1위 유지, 분당 재건축 선도지구 지정 주도." },
  ...
  { year: "1982–2001", title: "제32대 대한의사협회 회장", body: "제32대 대한의사협회 회장으로 의료 활동을 동반하며 사람과 생명을 우선하는 행정 철학의 토대를 마련." },
  { year: "1977–1991", title: "서울대학교 의대 졸업", body: "사람을 먼저 생각하는 의사의 길을 선택하며 공공의 책임을 배웠습니다." },
  { year: "    ~1976", title: "용산고등학교 졸업", body: "작은 약속도 지키는 자세로 책임감을 다져왔습니다." },
];
        ...
        <div className="container py-20 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16">
          ...
          <div className="lg:col-span-7 reveal">
            ...
            <p className="mt-5 text-[17px] leading-[1.85] text-foreground/80">
              ...
              148개 공약 중 134개 이행, 재정자립도 전국 1위, 분당 재건축 선도지구 지정이라는
